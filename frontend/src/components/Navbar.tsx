    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-5 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            {[["/#courses", "Courses"], ["/create", "Teach"], ["/dashboard", "Dashboard"], ["/earnings", "Earnings"], ["/stats", "Stats"]].map(([href, label]) => (
              <Link
                key={href}
                href={href}
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            {[["/#courses", "Courses"], ["/create", "Teach"], ["/dashboard", "Dashboard"], ["/earnings", "Earnings"], ["/stats", "Stats"]].map(([href, label], i) => (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 5 * 0.08 }}>
              <button
